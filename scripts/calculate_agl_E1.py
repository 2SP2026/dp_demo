...
def calculate_agl_stats():
    # Target directory for the E1 sensor data
    target_dir = r"C:\TempWork\EchoOne\DP event\E1 Vs WL\E1-Individual\Extract AGL"
    dem_path = os.path.join(target_dir, "E1-DP-LLProc20260428c-Comp-DEM1ftus.tif")
